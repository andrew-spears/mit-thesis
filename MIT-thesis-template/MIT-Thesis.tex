...
\ThesisDate{TODO: submission date}
...
\include{chapter3}% Register Refactoring
\include{chapter4}% Generalizing Memory and Register Operations
\include{chapter5}% Symbolic Execution and Rewriting for Vector Instructions
\include{chapter6}% Results
\include{chapter7}% Discussion and Future Work
