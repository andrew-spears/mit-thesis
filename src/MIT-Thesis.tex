...
\hypersetup{%
	pdfsubject={Formal verification of vector assembly in Fiat Cryptography},
...
\NewDocumentCommand{\codeshot}{m O{15pt} O{15pt}}{%
  \par\vspace*{#2}\includegraphics*[scale=0.2]{code-screenshots/#1.png}\vspace{#3}\par
}

\NewDocumentCommand{\codeshotfig}{m m O{15pt} O{15pt}}{%
  \begin{figure}[h]
  \vspace*{#3}\noindent\includegraphics*[scale=0.2]{code-screenshots/#1.png}\vspace{#4}
  \caption{#2}
  \label{fig:#1}
  \end{figure}
}

\newcommand{\depgraph}[3][0.5]{%
  \begin{figure}[h]
    \centering
    \begin{adjustbox}{center,margin*=-1in 0pt -1in 0pt}
      \includegraphics*[scale=#1]{dep_graphs/#2.png}
    \end{adjustbox}
    \caption{#3}
    \label{fig:#2}
  \end{figure}
...
%
 \Author{Andrew M. Spears}{Department of Electrical Engineering and Computer Science}
...
%
\Acceptor{Leslie A. Kolodziejski}{Professor of Electrical Engineering and Computer Science}{Chair, Department Committee on Graduate Students}
