...
\newcommand{\codeshot}[2][0.3]{%
  \noindent\includegraphics*[scale=#1]{code-screenshots/#2.png}\par
}

\newcommand{\codeshotfig}[3][0.3]{%
\begin{figure}[h]
  \noindent\includegraphics*[scale=#1]{code-screenshots/#2.png}
  \caption{#3}
  \label{fig:#2}
  \end{figure}
}
