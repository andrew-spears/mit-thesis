...
% \question{underlined sentence}{question for advisor}
% Underlines the sentence in red and adds a red footnote with the question.
% Use \texttt{...} inside (not \verb|...|, which can't appear in macro args).
\newcommand{\question}[2]{%
  {\color{red}#1}%
  \footnote{\color{red}\textbf{Q:} #2}%
}
...
\usepackage[style=ext-numeric-comp,giveninits=true,maxbibnames=99,sorting=none,language=american]{biblatex}
...
\hypersetup{%
	pdfsubject={Formal verification of vectorized assembly for cryptography},
	% Change this to briefly state topic of your thesis 
% 
	pdfkeywords={Andrew M. Spears, MIT, Massachusetts Institute of Technology},
...
\NewDocumentCommand{\codeshot}{m O{15pt} O{15pt}}{%
  \par\vspace*{#2}\includegraphics*[scale=0.2,alt={Rocq code snippet: #1}]{code-screenshots/#1.png}\vspace{#3}\par
}

\NewDocumentCommand{\codeshotfig}{m m O{15pt} O{15pt} O{}}{%
  \begin{figure}[h]
  \vspace*{#3}\noindent\includegraphics*[scale=0.2,alt={\ifx\relax#5\relax Rocq code snippet: #1\else #5\fi}]{code-screenshots/#1.png}\vspace{#4}
  \caption{#2}
  \label{fig:#1}
  \end{figure}
}

\NewDocumentCommand{\depgraph}{O{0.5} m m O{}}{%
  \begin{figure}[h]
    \centering
    \begin{adjustbox}{center,margin*=-1in 0pt -1in 0pt}
      \includegraphics*[scale=#1,alt={\ifx\relax#4\relax Dependency graph: #2\else #4\fi}]{dep_graphs/#2.png}
    \end{adjustbox}
    \caption{#3}
    \label{fig:#2}
  \end{figure}
...
\newcommand{\bind}{\texttt{\textbf{$\leftarrow$}}}
...
\title{Verified Equivalence Checking for Vector Assembly in Fiat Cryptography}

% \Author{Author full name}{Author department}[Author's first PREVIOUS degree][Author's second PREVIOUS degree][...
% Note that third, fourth, fifth, and sixth arguments are optional [] and may be omitted
%
 \Author{Andrew M. Spears}{Department of Electrical Engineering and Computer Science}[S.B. Computer Science and Engineering and Mathematics, Massachusetts Institute of Technology, 2025]
...
%
% No committee readers: committee members page will not be auto-generated.
