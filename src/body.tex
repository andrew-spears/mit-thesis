...
Fiat Cryptography~\autocite{fiatcrypto2019}\footnote{Source code for Fiat Cryptography and the work described in this thesis is available at \url{https://github.com/mit-plv/fiat-crypto}.} and CryptOpt~\autocite{cryptopt2023} are recent projects that attempt to solve this problem by synthesizing low-level programs and guaranteeing correctness through formal verification.
...
\begin{enumerate}
    ...
    \item Implementing symbolic execution for 19 AVX2 instructions, with modular abstractions designed to scale to additional instructions
...
Both scalar and vectorized sides are precompiled assembly linked against the same benchmark harness. 
